...
import { FloatRight, FloatLeft } from "@/animations/Float";
  ...
  return (
    <header className="text-shpe-white-100 from-shpe-blue-200 to-shpe-blue-150 relative isolate z-0 -mt-30 flex h-120 w-full justify-center overflow-hidden bg-linear-180 pt-25 md:justify-between">
      <motion.div
        ...
        whileInView="visible"
        viewport={viewport}
        className="relative z-10 my-auto flex w-full flex-col items-center pl-6 sm:pl-12 md:items-start lg:pl-24"
      >
      ...
      <motion.div
        ...
        whileInView="visible"
        viewport={viewport}
        className="absolute top-0 right-0 h-full w-full md:relative md:w-160"
      >
        <Image
          src={gear}
          alt="gear"
