...
const Navbar = () => {
  ...
  return (
    <div className="bg-shpe-white-100 border-shpe-blue-200 font-shpe-univers-condensed w-fill m-5 flex h-20 flex-row items-center justify-between justify-self-center rounded-3xl border px-5 z-100">
